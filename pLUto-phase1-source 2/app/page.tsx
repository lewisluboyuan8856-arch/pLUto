...
const features = [
  ...
  },
  {
    ...
    copy:
      "Every result is framed in student language so a paper feels usable right away, even before the live integrations are wired in."
  }
];
...
export default function HomePage() {
  ...
  const structuredData = {
    ...
    operatingSystem: "Web",
    description:
      "pLUto is an AI-powered research assistant prototype that helps students sharpen research questions, understand paper relevance, and build a shortlist.",
    offers: {
      "@type": "Offer",
      price: "0",
      priceCurrency: "USD"
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <p className="max-w-2xl text-lg leading-8 text-white/78">
                {APP_NAME} is a production-style frontend MVP for a student research assistant. In
                this first phase, the entire experience runs on curated mock papers so we can nail
                search flow, paper cards, notes, and shortlist behavior before live APIs arrive.
              </p>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              <div className="rounded-[1.75rem] border border-white/10 bg-white/8 p-5 backdrop-blur">
                ...
                <p className="mt-4 text-2xl font-semibold">4 research tracks</p>
                <p className="mt-1 text-sm text-white/68">Curated mock topics for Phase 1</p>
              </div>
              <div className="rounded-[1.75rem] border border-white/10 bg-white/8 p-5 backdrop-blur">
      ...
      <section className="mx-auto grid max-w-7xl gap-10 px-6 pb-24 lg:grid-cols-[0.95fr_1.05fr] lg:px-8">
        <div className="rounded-[2.25rem] bg-ink p-10 text-white shadow-glow">
          ...
          <h2 className="mt-4 font-display text-4xl leading-tight">
            The student experience is fully designed before the live plumbing starts.
          </h2>
          <p className="mt-5 max-w-xl text-base leading-8 text-white/74">
            This MVP already proves the product flow: landing, search, results, article detail,
            and a saved-paper workspace. The next phases will swap mock logic for real APIs and
            authentication without rethinking the interface from scratch.
          </p>
        </div>
        <div className="grid gap-5">
          {[
            ...
            "Keeps the structure ready for real integrations in later phases"
          ].map((item) => (
