    ...
    return (
      <div className="mt-10 rounded-[2rem] border border-dashed border-ink/15 bg-white p-10 text-center">
        ...
        <p className="mx-auto mt-3 max-w-2xl text-sm leading-7 text-ink/60">
          Save papers from the mock results page and they will appear here with notes and citation tools. For Phase 1, everything is stored in this browser only.
        </p>
          ...
          <div className="mt-6 grid gap-6 lg:grid-cols-2">
            <div className="rounded-[1.5rem] bg-paper p-5">
              ...
              <p className="mt-4 text-sm leading-7 text-ink/75">
                Quick-copy buttons are available here in Phase 1 so the interaction can be tested before database persistence is added.
              </p>
              <div className="mt-4">
